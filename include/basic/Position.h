...
namespace hdg {
     ...
     *              另一类是易于人类观看的二维坐标（line，col）。其中 line 从 1 开始索引， col从 1 开始索引。
     *
     * @warning     该结构体内部的三个变量都是无符号长整型（size_t），所以要格外注意类型转换造成的问题。
     * */
    ...
    public:
        ...
        void setStart(size_t index, size_t line, size_t col);
